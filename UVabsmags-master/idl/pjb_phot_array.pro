...
;;;; based on pjb_phot_array_B141 but designed to be updated

;;;; needs to average data points when multiple points are in the same delta_t bin

;;;; make separate mjd and mag arrays which contain all points from all filters so they can be looped through

PRO pjb_phot_read, infile, x
...
PRO pjb_phot_array, infile, dt=dt, fitsfile=fitsfile, delta_t=delta_t, tex6file=tex6file
